...
function fieldClassName() {
  return "mt-1 w-full rounded-[10px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-input)] px-3 py-2 text-[14px] text-[var(--rk-ink)] outline-none";
}
...
export function SkillDraftCard({
  ...
  return (
    <div
      ...
      className="w-[min(520px,92%)] rounded-[20px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-[18px] py-4"
    >
