...
export function McpServersOverlay({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center bg-[rgba(4,4,5,.62)] p-6">
      <section
        className="flex max-h-full w-[1080px] max-w-full flex-col overflow-hidden rounded-[26px] border border-[#2A2A31] bg-[var(--rk-panel)] shadow-[0_40px_90px_rgba(0,0,0,.55)]"
      ...
      >
        ...
        <div className="rk-scroll grid min-h-0 grid-cols-1 gap-6 overflow-y-auto p-8 lg:grid-cols-[1fr_1.08fr]">
          <div className="rounded-2xl border border-[#292930] bg-[var(--rk-input)] p-5">
            ...
            <input
              ...
              className="mb-4 w-full rounded-xl border border-[#303038] bg-[var(--rk-input)] px-3 py-2.5 text-sm text-[var(--rk-ink)] outline-none"
            />
            <div className="mb-4 grid grid-cols-3 gap-1 rounded-xl border border-[#303038] bg-[var(--rk-input)] p-1">
              {(
                [
            ...
            <input
              ...
              className="mb-3 w-full rounded-xl border border-[#303038] bg-[var(--rk-input)] px-3 py-2.5 text-sm text-[var(--rk-ink)] outline-none"
            />
            {transport !== "stdio" ? (
              <div className="grid grid-cols-[.7fr_1fr] gap-2">
                <input
                  ...
                  className="rounded-xl border border-[#303038] bg-[var(--rk-input)] px-3 py-2.5 text-xs text-[var(--rk-ink)] outline-none"
                />
                <input
            ...
            <div>
              ...
              <div className="mt-3 space-y-2">
                {bots.map((bot) => (
                  <label
                    key={bot.id}
                    className="flex cursor-pointer items-center gap-3 rounded-xl border border-[#292930] bg-[var(--rk-input)] px-3 py-3"
                  >
                    <input
                      type="checkbox"
              ...
              <div className="mt-3 space-y-2">
                {servers.length === 0 ? (
                  ...
                  servers.map((server) => (
                    <div
                      key={server.id}
                      className="rounded-xl border border-[#292930] bg-[var(--rk-input)] p-4"
                    >
