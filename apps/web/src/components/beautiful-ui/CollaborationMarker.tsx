...
export function CollaborationMarker({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="flex items-center justify-center gap-1.5 self-center rounded-full px-2.5 py-1 text-[13px] text-[var(--rk-muted)] transition-colors hover:bg-[var(--rk-hover)] hover:text-[#B8B8BD]"
    >
